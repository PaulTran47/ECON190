\title{Pomona College Economics Senior Activity}
...
\documentclass[a4paper,12pt,leqno,openbib, openany, reqno]{memoir} %add 'draft' to turn draft option on (see below)
%
%
% Adding metadata:
\usepackage{datetime}
...
\pdfinfo{
   /Author (Derrick Choe, Paul Le Tran)
   /Title (Pomona College Economics Activity)
...
%
% Sets heading level in the table of contents
...
\usepackage{fixltx2e}					%Eliminates some in felicities of the %original LaTeX kernel
\usepackage[vietnamese,british]{babel}	%Format is foreign-language,main-language								 %For languages characters and hyphenation
